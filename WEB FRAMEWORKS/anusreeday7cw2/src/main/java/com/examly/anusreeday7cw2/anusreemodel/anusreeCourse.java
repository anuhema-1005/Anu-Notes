...
public class anusreeCourse {
     ...
     public anusreeCourse() {

     }

     public anusreeCourse(int courseId, String courseName, int creditHours, String instructor, String preRequistes,
