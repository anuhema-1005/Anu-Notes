...
public class anusreeVillage {
    ...
    public anusreeVillage(){}
    public anusreeVillage(int villageId, String villageName, int numOfMen, int numOfWomen, int villagePopulation,
            int numOfSchools) {
