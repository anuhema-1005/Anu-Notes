...
public class AnusreeChildren {
     ...
     public AnusreeChildren() {

     }

     public AnusreeChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
