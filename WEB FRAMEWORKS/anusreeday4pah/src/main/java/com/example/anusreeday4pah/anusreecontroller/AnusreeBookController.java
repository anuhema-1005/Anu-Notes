...
import com.example.day4pah.service.AnusreeBookService;
...
@RestController
public class AnusreeBookController {
    public AnusreeBookService bookService;
    public AnusreeBookController(AnusreeBookService bookService)
    {
