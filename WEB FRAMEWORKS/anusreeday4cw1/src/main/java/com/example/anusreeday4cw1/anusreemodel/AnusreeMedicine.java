package com.example.anusreeday4cw1.anusreemodel;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class AnusreeMedicine {
    @Id
    ...
    public AnusreeMedicine() {
    }
    public AnusreeMedicine(int medicineId, String medicineName, String medicineFor, String medicineBrand,
